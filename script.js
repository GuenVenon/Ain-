...
function changeLanguage() {
    ...
    // Show/hide images based on selected language
    const englishImages = document.querySelectorAll('.english-images');
    const malayImages = document.querySelectorAll('.malay-images');

    if (language === 'ms') {
        englishImages.forEach(img => img.style.display = 'none');
        malayImages.forEach(img => img.style.display = 'block');
    } else {
        englishImages.forEach(img => img.style.display = 'block');
        malayImages.forEach(img => img.style.display = 'none');
    }
}
...
function toggleLanguage(lang) {
    if (lang === 'english') {
        ...
        document.querySelector('.english-images').style.display = 'block';
        document.querySelector('.malay-content').style.display = 'none';
        document.querySelector('.malay-images').style.display = 'none';
    } else {
        document.querySelector('.english-content').style.display = 'none';
        document.querySelector('.english-images').style.display = 'none';
        document.querySelector('.malay-content').style.display = 'block';
        document.querySelector('.malay-images').style.display = 'block';
    }
}
